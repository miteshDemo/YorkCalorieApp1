...
import { AppBar, Toolbar, Typography, Avatar, Button, CircularProgress, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Drawer, IconButton } from "@mui/material";
  ...
  return (
    ...
    >
      ...
      <Typography sx={{ width: "100%", maxWidth: "752px", padding: { xs: "10px", md: "20px" }, mt: 2 }}>
        {!image && !loading && (
          <UploadContainer>
            <input type="file" accept="image/*" onChange={handleImageUpload} className="hidden" id="upload-button" />
      ...
      <Drawer anchor="right" open={drawerOpen} onClose={toggleDrawer}>
        <Paper sx={{ width: 250, p: 2, height: "100%" }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8 }}>
            <Avatar
              src={user?.avatarUrl || ""}
              sx={{ width: 56, height: 56, bgcolor: user?.avatarUrl ? "transparent" : "black", mb: 1 }}
            >
